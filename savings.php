...
$sql = "SELECT * FROM SavingsBankInterest";
$result = $conn->query($sql);
?>

<section id = "table" class= "bg-darkest-black">
<div class="container">
<div class="caption">Savings Bank Interest</div>	
<div id="table">
...
if (array_key_exists('options', $_GET) || array_key_exists('options', $_GET))
{
    foreach($_GET['options'] as $value){
       ...
       mysqli_query($conn, "DELETE FROM SavingsBankInterest WHERE bank_name = '$s[0]' and amount = '$s[1]' and account_number = '$s[2]' and payment_method = '$s[3]' and receipt_number = '$s[4]'");
