...
$sql = "SELECT * FROM PlotSale";
$result = $conn->query($sql);
?>

<section id = "table" class= "bg-darkest-black">
<div class="container">
<div class="caption">Plot Sale</div>	
<div id="table">
<div class="header-row row">
    ...
    <span class="cell">Bearer</span>
    <span class="cell">Percentage Amount</span>
...
if (array_key_exists('options', $_GET) || array_key_exists('options', $_GET))
{
    foreach($_GET['options'] as $value){
       ...
       mysqli_query($conn, "DELETE FROM PlotSale WHERE member_name = '$s[0]' and plot_number = '$s[1]' and date = '$s[2]' and amount = '$s[3]' and to_whom = '$s[4]' and percentage_amount = '$s[5]' and payment_method = '$s[6]' and cheque_number = '$s[7]' ");
