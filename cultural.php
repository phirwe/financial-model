...
<div class="container">
<div class="caption">Cultural</div>	
<div id="table">
...
if (array_key_exists('options', $_GET) || array_key_exists('options', $_GET))
{
    foreach($_GET['options'] as $value){
      ...
      mysqli_query($conn, "DELETE FROM Cultural WHERE type = '$s[0]' and description = '$s[1]' and pay_to = '$s[2]' and payment_date = '$s[3]' and payment_method = '$s[4]' and cheque_number = '$s[5]' and amount_spent = '$s[6]' and late_fee_fine = '$s[7]' and total_amount = '$s[8]'  ");
