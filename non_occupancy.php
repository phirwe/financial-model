...
$sql = "SELECT * FROM NonOccupancy";
$result = $conn->query($sql);
?>

<section id = "table" class= "bg-darkest-black">
<div class="container">
<div class="caption">Miscellaneous</div>	
<div id="table">
...
if (array_key_exists('options', $_GET) || array_key_exists('options', $_GET))
{
    foreach($_GET['options'] as $value){
       ...
       mysqli_query($conn, "DELETE FROM NonOccupancy WHERE member_name = '$s[0]' and plot_number = '$s[1]' and payment_date = '$s[2]' and amount_paid = '$s[3]' and duration = '$s[4]' and late_fee_fine = '$s[5]' and payment_date = '$s[6]' and cheque_number = '$s[7]' ");
